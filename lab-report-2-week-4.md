...
Attached is the problem of the test file 3. In this test, it is asking the program to return multiple links without returning the one with an incorrect format. Theoretically, the code should return the links written in the file. However, one of the links in there has a wrong heading which starts with "!", which makes it illegal. Hence, no links can be return.

[InsertMultipleLinks](https://github.com/FishInAZ/cse15l-lab-reports-2-testFiles/blob/main/test-file3.md)
